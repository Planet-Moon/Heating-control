...
src_serial = 1901425325 # = 71 55 72 AD (intel format, little endian)
dst_serial = 304913813 # = 95 9D 2C 12 (intel format, little endian)

comm_port = 9522
comm_dst = '192.168.178.110'
...
_DelayedCallObj = reactor.callLater(50, callfunc, "callfunc called after 50 sec")
