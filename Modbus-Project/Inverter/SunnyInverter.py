...
class sma_BatteryInverter(sma_SolarInverter):
    ...
    def _Init_Battery_Modbus_Registers(self):
        ...
        self.modbus.newRegister("Batterietemperatur", address=30849, length=2, signed=True, type_="float", unit=" °C")
        self.modbus.newRegister("Batteriespannung", address=30851, length=2, signed=False, type_="float", unit=" V")
